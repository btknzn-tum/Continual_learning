...
\todo{no-anchor ($\lambda{=}0$) and frozen-encoder ($q{=}0$) controls running
to isolate the anchor's contribution; RanPAC-head combination queued; 5-seed
promotion pending}
...
\multirow{2}{*}{C100 (10 t.)}
 & last tap & 31.9$\pm$0.8 (58.3) & 34.3$\pm$1.3 (4.8) & 63.4 & 69.1$^*$ \\
