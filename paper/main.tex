...
(\cref{sec:honest}) rather than encoder features limits our adapter, we also
fit a streaming RanPAC ridge head on the (lightly adapted) encoder's
multi-tap features. \todo{fivedata combination result vs.\ frozen RanPAC 87.3
--- run in progress}
