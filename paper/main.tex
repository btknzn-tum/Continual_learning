...
and \todo{selective encoder plasticity results pending} how far frozen features
can be pushed.
\end{abstract}
...
block9 & 74.4$\pm$2.1 (20.7) & 87.3$\pm$0.5 (1.0) & \todo{} \\
...
further to $h{=}1024$ (97.87$^*$) does \emph{not} reproduce the multi-tap gain
--- the widest adapter is in fact \emph{worse} than the narrowest. Parameter
count is not the active ingredient; placement is.
\todo{EWC h1024, LoRA rows, C100 capacity from compare chain; 5-seed
promotion via phase2}
...
\section{Conclusion}
\todo{write after results finalized}
