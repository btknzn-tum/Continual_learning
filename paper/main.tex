...
Plasticity has a \emph{budget} along two axes. Exposure: at 20 epochs per task
the same mechanism over-drifts (77.0, below the frozen 78.1), where 10 epochs
gains $+3.1$. Fraction: quadrupling the trainable share to $q{=}0.2$ (with a
weakened anchor) nudges accuracy up to 81.9 but at $2.6\times$ the forgetting
(11.7 vs.\ 4.5), a strictly worse operating point than $q{=}0.05$. Brief,
sparse, well-anchored plasticity adapts; more of any of the three erodes.
The feature-similarity anchor is what buys the stability: removing it
($\lambda{=}0$) leaves accuracy essentially unchanged (81.9 vs.\ 81.2) but
raises forgetting from 4.5 to 7.3 --- the anchor is a pure
stability regularizer, trading no accuracy for a $1.6\times$ reduction in
forgetting. \todo{frozen-encoder ($q{=}0$) control and RanPAC-head combination
running; 5-seed promotion pending}
